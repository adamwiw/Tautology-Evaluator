...
public class Infix {
	...
	return(!token.equals("~") && !token.equals("&") && !token.equals("v") && !token.equals("-->") && !token.equals("<-->"));
    }

    private LLQueueADT postfix() {
    ...
    private boolean apply(boolean p, boolean q, String operator) throws ParseException {
	if(operator.equals("-->"))
